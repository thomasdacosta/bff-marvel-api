...
public class MarvelClientImpl implements MarvelClient {
	...
	public ResponseEntity<Resource> image(URI baseUri) {
		return marvelApi.image(baseUri);
	}

	@Override
	public ResponseEntity<CharacterDataWrapper> characterById(String characterId) {
		return marvelApi.characterById(ts, apikey, hash, characterId);
	}

	@Override
	public ResponseEntity<ComicDataWrapper> characterComics(String characterId, @Valid String format,
		...
		return marvelApi.characterComics(ts, apikey, hash, characterId, format, formatType, noVariants, dateDescriptor,
				dateRange, diamondCode, digitalId, upc, isbn, ean, issn, hasDigitalIssue, modifiedSince, creators,
				series, events, stories, sharedAppearances, collaborators, orderBy, limit, offset);
	}

	@Override
	public ResponseEntity<EventDataWrapper> characterEvents(String characterId, @Valid String name,
	...
	@Override
	public ResponseEntity<SeriesDataWrapper> characterSeries(String characterId, @Valid String title,
	...
	@Override
	public ResponseEntity<StoryDataWrapper> characterStories(String characterId, @Valid String modifiedSince,
			@Valid BigDecimal comics, @Valid BigDecimal series, @Valid BigDecimal events, @Valid BigDecimal creators,
			@Valid String orderBy, @Valid BigDecimal limit, @Valid BigDecimal offset) {
		return marvelApi.characterStories(ts, apikey, hash, characterId, modifiedSince, comics, series, events,
				creators, orderBy, limit, offset);
	}

	@Override
	public ResponseEntity<ComicDataWrapper> comicById(String comicId) {
		return marvelApi.comicById(ts, apikey, apikey, comicId);
	}

	@Override
	public ResponseEntity<CharacterDataWrapper> comicCharacters(String comicId, @Valid String name,
			@Valid String nameStartsWith, @Valid String modifiedSince, @Valid BigDecimal series,
	...
	@Override
	public ResponseEntity<CreatorDataWrapper> comicCreators(String comicId, @Valid String firstName,
			@Valid String middleName, @Valid String lastName, @Valid String suffix, @Valid String nameStartsWith,
	...
	@Override
	public ResponseEntity<EventDataWrapper> comicEvents(String comicId, @Valid String name,
			@Valid String nameStartsWith, @Valid String modifiedSince, @Valid BigDecimal creators,
		...
		return marvelApi.comicEvents(ts, apikey, hash, comicId, name, nameStartsWith, modifiedSince, creators,
				characters, series, stories, orderBy, limit, offset);
	}

	@Override
	public ResponseEntity<StoryDataWrapper> comicStories(String comicId, @Valid String modifiedSince,
			@Valid BigDecimal series, @Valid BigDecimal events, @Valid BigDecimal creators,
	...
	public ResponseEntity<CreatorDataWrapper> creatorById(String creatorId) {
		return marvelApi.creatorById(ts, apikey, hash, creatorId);
	}

	@Override
	public ResponseEntity<ComicDataWrapper> creatorComics(String creatorId, @Valid String format,
			@Valid String formatType, @Valid Boolean noVariants, @Valid String dateDescriptor,
			@Valid BigDecimal dateRange, @Valid String diamondCode, @Valid BigDecimal digitalId, @Valid String upc,
			@Valid String isbn, @Valid String ean, @Valid String issn, @Valid Boolean hasDigitalIssue,
	...
	@Override
	public ResponseEntity<EventDataWrapper> creatorEvents(String creatorId, @Valid String name,
			@Valid String nameStartsWith, @Valid String modifiedSince, @Valid BigDecimal characters,
			@Valid BigDecimal series, @Valid BigDecimal comics, @Valid BigDecimal stories, @Valid String orderBy,
			@Valid BigDecimal limit, @Valid BigDecimal offset) {
	...
	@Override
	public ResponseEntity<SeriesDataWrapper> creatorSeries(String creatorId, @Valid String title,
			@Valid String titleStartsWith, @Valid BigDecimal startYear, @Valid String modifiedSince,
			@Valid BigDecimal comics, @Valid BigDecimal stories, @Valid BigDecimal events, @Valid BigDecimal characters,
			@Valid String seriesType, @Valid String contains, @Valid String orderBy, @Valid BigDecimal limit,
			@Valid BigDecimal offset) {
		return marvelApi.creatorSeries(ts, apikey, hash, creatorId, title, titleStartsWith, startYear, modifiedSince,
				comics, stories, events, characters, seriesType, contains, orderBy, limit, offset);
	}

	@Override
	public ResponseEntity<StoryDataWrapper> creatorStories(String creatorId, @Valid String modifiedSince,
			@Valid BigDecimal comics, @Valid BigDecimal series, @Valid BigDecimal events, @Valid BigDecimal characters,
			@Valid String orderBy, @Valid BigDecimal limit, @Valid BigDecimal offset) {
	...
	public ResponseEntity<EventDataWrapper> eventById(String eventId) {
		return marvelApi.eventById(ts, apikey, hash, eventId);
	}

	@Override
	public ResponseEntity<CharacterDataWrapper> eventCharacters(String eventId, @Valid String name,
	...
	@Override
	public ResponseEntity<ComicDataWrapper> eventComics(String eventId, @Valid String format, @Valid String formatType,
			...
			@Valid BigDecimal events, @Valid BigDecimal stories, @Valid BigDecimal sharedAppearances,
			@Valid BigDecimal collaborators, @Valid String orderBy, @Valid BigDecimal limit, @Valid BigDecimal offset) {
		return marvelApi.eventComics(ts, apikey, hash, eventId, format, formatType, noVariants, dateDescriptor,
				dateRange, diamondCode, digitalId, upc, isbn, ean, issn, hasDigitalIssue, modifiedSince, creators,
				characters, series, events, stories, sharedAppearances, collaborators, orderBy, limit, offset);
	}

	@Override
	public ResponseEntity<CreatorDataWrapper> eventCreators(String eventId, @Valid String firstName,
			@Valid String middleName, @Valid String lastName, @Valid String suffix, @Valid String nameStartsWith,
			@Valid String firstNameStartsWith, @Valid String middleNameStartsWith, @Valid String lastNameStartsWith,
			@Valid String modifiedSince, @Valid BigDecimal comics, @Valid BigDecimal series, @Valid BigDecimal stories,
			@Valid String orderBy, @Valid BigDecimal limit, @Valid BigDecimal offset) {
	...
	@Override
	public ResponseEntity<SeriesDataWrapper> eventSeries(String eventId, @Valid String title,
			@Valid String titleStartsWith, @Valid BigDecimal startYear, @Valid String modifiedSince,
			@Valid BigDecimal comics, @Valid BigDecimal stories, @Valid BigDecimal creators,
	...
	@Override
	public ResponseEntity<StoryDataWrapper> eventStories(String eventId, @Valid String modifiedSince,
			@Valid BigDecimal comics, @Valid BigDecimal series, @Valid BigDecimal creators,
			@Valid BigDecimal characters, @Valid String orderBy, @Valid BigDecimal limit, @Valid BigDecimal offset) {
	...
	@Override
	public ResponseEntity<InlineResponse200> listCharacters(@Valid String name, @Valid String nameStartsWith,
	...
	@Override
	public ResponseEntity<ComicDataWrapper> listComics(@Valid String format, @Valid String formatType,
			@Valid Boolean noVariants, @Valid String dateDescriptor, @Valid BigDecimal dateRange,
			@Valid String diamondCode, @Valid BigDecimal digitalId, @Valid String upc, @Valid String isbn,
			@Valid String ean, @Valid String issn, @Valid Boolean hasDigitalIssue, @Valid String modifiedSince,
			@Valid BigDecimal creators, @Valid BigDecimal characters, @Valid BigDecimal series,
	...
	@Override
	public ResponseEntity<CreatorDataWrapper> listCreators(@Valid String firstName, @Valid String middleName,
	...
	@Override
	public ResponseEntity<EventDataWrapper> listEvents(@Valid String name, @Valid String nameStartsWith,
	...
	@Override
	public ResponseEntity<SeriesDataWrapper> listSeries(@Valid String title, @Valid String titleStartsWith,
			@Valid BigDecimal startYear, @Valid String modifiedSince, @Valid BigDecimal comics,
			@Valid BigDecimal stories, @Valid BigDecimal events, @Valid BigDecimal creators,
			@Valid BigDecimal characters, @Valid String seriesType, @Valid String contains, @Valid String orderBy,
			@Valid BigDecimal limit, @Valid BigDecimal offset) {
		return marvelApi.listSeries(ts, apikey, hash, title, titleStartsWith, startYear, modifiedSince, comics, stories,
				events, creators, characters, seriesType, contains, orderBy, limit, offset);
	}

	@Override
	public ResponseEntity<StoryDataWrapper> listStories(@Valid String modifiedSince, @Valid BigDecimal comics,
			@Valid BigDecimal series, @Valid BigDecimal events, @Valid BigDecimal creators,
			@Valid BigDecimal characters, @Valid String orderBy, @Valid BigDecimal limit, @Valid BigDecimal offset) {
	...
	public ResponseEntity<SeriesDataWrapper> seriesById(String seriesId) {
		return marvelApi.seriesById(ts, apikey, hash, seriesId);
	}

	@Override
	public ResponseEntity<CharacterDataWrapper> seriesCharacters(String seriesId, @Valid String name,
			@Valid String nameStartsWith, @Valid String modifiedSince, @Valid BigDecimal comics,
			@Valid BigDecimal events, @Valid BigDecimal stories, @Valid String orderBy, @Valid BigDecimal limit,
			@Valid BigDecimal offset) {
	...
	@Override
	public ResponseEntity<ComicDataWrapper> seriesComics(String seriesId, @Valid String format,
			@Valid String formatType, @Valid Boolean noVariants, @Valid String dateDescriptor,
			@Valid BigDecimal dateRange, @Valid String diamondCode, @Valid BigDecimal digitalId, @Valid String upc,
			@Valid String isbn, @Valid String ean, @Valid String issn, @Valid Boolean hasDigitalIssue,
			@Valid String modifiedSince, @Valid BigDecimal creators, @Valid BigDecimal characters,
			@Valid BigDecimal events, @Valid BigDecimal stories, @Valid BigDecimal sharedAppearances,
			@Valid BigDecimal collaborators, @Valid String orderBy, @Valid BigDecimal limit, @Valid BigDecimal offset) {
		return marvelApi.seriesComics(ts, apikey, hash, seriesId, format, formatType, noVariants, dateDescriptor,
				dateRange, diamondCode, digitalId, upc, isbn, ean, issn, hasDigitalIssue, modifiedSince, creators,
				characters, events, stories, sharedAppearances, collaborators, orderBy, limit, offset);
	}

	@Override
	public ResponseEntity<CreatorDataWrapper> seriesCreators(String seriesId, @Valid String firstName,
			@Valid String middleName, @Valid String lastName, @Valid String suffix, @Valid String nameStartsWith,
			@Valid String firstNameStartsWith, @Valid String middleNameStartsWith, @Valid String lastNameStartsWith,
	...
	@Override
	public ResponseEntity<EventDataWrapper> seriesEvents(String seriesId, @Valid String name,
			@Valid String nameStartsWith, @Valid String modifiedSince, @Valid BigDecimal creators,
		...
		return marvelApi.seriesEvents(ts, apikey, hash, seriesId, name, nameStartsWith, modifiedSince, creators,
				characters, comics, stories, orderBy, limit, offset);
	}

	@Override
	public ResponseEntity<StoryDataWrapper> seriesStories(String seriesId, @Valid String modifiedSince,
			@Valid BigDecimal comics, @Valid BigDecimal events, @Valid BigDecimal creators,
			@Valid BigDecimal characters, @Valid String orderBy, @Valid BigDecimal limit, @Valid BigDecimal offset) {
	...
	public ResponseEntity<StoryDataWrapper> storyById(String storyId) {
		return marvelApi.storyById(ts, apikey, hash, storyId);
	}

	@Override
	public ResponseEntity<CharacterDataWrapper> storyCharacters(String storyId, @Valid String name,
			@Valid String nameStartsWith, @Valid String modifiedSince, @Valid BigDecimal comics,
		...
		return marvelApi.storyCharacters(ts, apikey, hash, storyId, name, nameStartsWith, modifiedSince, comics, series,
				events, orderBy, limit, offset);
	}

	@Override
	public ResponseEntity<ComicDataWrapper> storyComics(String storyId, @Valid String format, @Valid String formatType,
			@Valid Boolean noVariants, @Valid String dateDescriptor, @Valid BigDecimal dateRange,
			@Valid String diamondCode, @Valid BigDecimal digitalId, @Valid String upc, @Valid String isbn,
			@Valid String ean, @Valid String issn, @Valid Boolean hasDigitalIssue, @Valid String modifiedSince,
			@Valid BigDecimal creators, @Valid BigDecimal characters, @Valid BigDecimal series,
		...
		return marvelApi.storyComics(ts, apikey, hash, storyId, format, formatType, noVariants, dateDescriptor,
				dateRange, diamondCode, digitalId, upc, isbn, ean, issn, hasDigitalIssue, modifiedSince, creators,
				characters, series, events, sharedAppearances, collaborators, orderBy, limit, offset);
	}

	@Override
	public ResponseEntity<CreatorDataWrapper> storyCreators(String storyId, @Valid String firstName,
			@Valid String middleName, @Valid String lastName, @Valid String suffix, @Valid String nameStartsWith,
			@Valid String firstNameStartsWith, @Valid String middleNameStartsWith, @Valid String lastNameStartsWith,
			@Valid String modifiedSince, @Valid BigDecimal comics, @Valid BigDecimal series, @Valid BigDecimal events,
			@Valid String orderBy, @Valid BigDecimal limit, @Valid BigDecimal offset) {
	...
	@Override
	public ResponseEntity<EventDataWrapper> storyEvents(String storyId, @Valid String name,
			@Valid String nameStartsWith, @Valid String modifiedSince, @Valid BigDecimal creators,
		...
		return marvelApi.storyEvents(ts, apikey, hash, storyId, name, nameStartsWith, modifiedSince, creators,
				characters, series, comics, orderBy, limit, offset);
	}

	@Override
	public ResponseEntity<SeriesDataWrapper> storySeries(String storyId, @Valid BigDecimal events, @Valid String title,
			@Valid String titleStartsWith, @Valid BigDecimal startYear, @Valid String modifiedSince,
		...
		return marvelApi.storySeries(ts, apikey, hash, storyId, events, title, titleStartsWith, startYear,
				modifiedSince, comics, creators, characters, seriesType, contains, orderBy, limit, offset);
	}
