...
echo ### Criando Stack do CloudFormation
echo aws --endpoint http://localhost:4566 --profile localstack cloudformation create-stack --stack-name marvelStack --template-body file://bff-marvel-cdk_localstack.yml
