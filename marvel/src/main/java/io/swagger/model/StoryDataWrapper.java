...
public class StoryDataWrapper {
	...
	public boolean equals(java.lang.Object o) {
		...
		return Objects.equals(this.code, storyDataWrapper.code) && Objects.equals(this.status, storyDataWrapper.status)
				...
				&& Objects.equals(this.data, storyDataWrapper.data) && Objects.equals(this.etag, storyDataWrapper.etag);
	}
